...
describe('@mantine/theme/get-focus-styles', () => {
    it('uses primaryColor from given theme', () => {
        expect(getFocusStyles(Object.assign(Object.assign({}, DEFAULT_THEME), { primaryColor: 'red' }))['&:focus'].boxShadow.includes(DEFAULT_THEME.colors.red[5])).toBe(true);
    });
    it('produces :focus and :focus-visible selectors', () => {
        const styles = getFocusStyles(Object.assign(Object.assign({}, DEFAULT_THEME), { primaryColor: 'red' }));
