(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-jss'), require('clsx'), require('@mantine/hooks'), require('react-transition-group'), require('react-dom'), require('react-textarea-autosize')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-jss', 'clsx', '@mantine/hooks', 'react-transition-group', 'react-dom', 'react-textarea-autosize'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@mantine/core'] = {}, global.React, global.reactJss, global.cx, global.hooks, global.reactTransitionGroup, global.reactDom, global.TextareaAutosize));
}(this, (function (exports, React, reactJss, cx, hooks, reactTransitionGroup, reactDom, TextareaAutosize) { 'use strict';
  ...
  function CardsGrid(_a) {
    ...
    return /* @__PURE__ */ React__default['default'].createElement("div", __spreadValues$Y({
      className: cx__default['default'](classes.grid, className)
    }, others), children);
  }
  ...
  function Container(_a) {
    ...
    return /* @__PURE__ */ React__default['default'].createElement("div", __spreadValues$P({
      className: cx__default['default'](classes.container, className)
    }, others));
  }
  ...
  function ElementsGroup(_a) {
    ...
    const items = React.Children.toArray(children).map((child) => React__default['default'].cloneElement(child, {className: cx__default['default'](classes.child, child.props.className)}));
  ...
  function Kbd(_a) {
    ...
    return /* @__PURE__ */ React__default['default'].createElement("kbd", __spreadValues$A({
      className: cx__default['default'](classes.kbd, className)
    }, others), children);
  }
