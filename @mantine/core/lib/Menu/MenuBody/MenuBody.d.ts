...
declare function MenuBody({ className, themeOverride, opened, onClose, transition, transitionDuration, transitionTimingFunction, style, children, size, shadow, closeOnClickOutside, closeOnItemClick, zIndex, ...others }: MenuBodyProps): JSX.Element;
declare namespace MenuBody {
