...
export function CheckboxIcon(_a) {
    var { intermediate } = _a, others = __rest(_a, ["intermediate"]);
    return (React.createElement("svg", Object.assign({ width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, others),
        React.createElement("path", { d: intermediate
