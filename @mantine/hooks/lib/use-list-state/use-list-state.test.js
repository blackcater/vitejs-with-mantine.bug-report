...
describe('@mantine/hooks/use-list-state', () => {
    ...
    it('applies given function to all items with handlers.apply', () => {
        ...
        act(() => {
            ...
            handlers.apply((item, index) => (Object.assign(Object.assign({}, item), { age: index + item.age })));
        });
        const [state] = hook.result.current;
        expect(state).toEqual([
            TEST_STATE[0],
            Object.assign(Object.assign({}, TEST_STATE[1]), { age: TEST_STATE[1].age + 1 }),
            Object.assign(Object.assign({}, TEST_STATE[2]), { age: TEST_STATE[2].age + 2 }),
        ]);
    });
    ...
    it('sets given item property at given position with handlers.setItemProp', () => {
        ...
        const [state] = hook.result.current;
        expect(state).toEqual([TEST_STATE[0], Object.assign(Object.assign({}, TEST_STATE[1]), { age: 90 }), TEST_STATE[2]]);
    });
