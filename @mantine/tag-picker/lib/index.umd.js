(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@mantine/hooks'), require('@mantine/core'), require('clsx'), require('react-jss')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@mantine/hooks', '@mantine/core', 'clsx', 'react-jss'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@mantine/tag-picker'] = {}, global.React, global['@mantine/hooks'], global['@mantine/core'], global.cx, global.reactJss));
}(this, (function (exports, React, hooks, core, cx, reactJss) { 'use strict';
